      ...
      <div className="app">
        ...
        <footer className="footer">
          <div className="footer-links">
            {/* MonadScan */}
            <a
              href="https://monadscan.com/address/0x9d5aD64997C26ca505f11fDE71789eb3c664EE60"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-link fl-monad"
            >
            ...
            {/* MonadVision */}
            <a
              href="https://monadvision.com/address/0x9d5aD64997C26ca505f11fDE71789eb3c664EE60?portofolio=info"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-link fl-vision"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            ...
            {/* BlockVision */}
            <a
              href="https://dashboard.blockvision.org/pricing"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-link fl-block"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            ...
            {/* Twitter / X */}
            <a
              href="https://twitter.com/bnbgold277983"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-link fl-tw"
            >
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        {step === "buy" && (
          <div className="step-section">
            ...
            <button className="btn btn-gold" onClick={handleBuyKey} disabled={!account || isPending}>
        ...
        {step === "guess" && (
          <div className="step-section">
            ...
            <button className="btn btn-green" onClick={handleTryCode} disabled={isPending || turnsLeft === 0}>
...
function HowToPlay() {
  const steps = [
    ...
    ["2", "Choose a Key",    "Bronze 100 · Silver 500 · Gold 1,000 · Platinum 10,000 MON"],
    ["3", "Spin the Wheel",  "Spin to get your starting combination"],
    ["4", "Try the Code",    "4 attempts to guess the correct 4-digit vault code"],
    ["5", "Win the Pool",    "Crack it → receive full vault pool + Winner NFT!"],
  ];
  return (
    <div className="howto">
...
.key-card:hover .key-vault-img {
  filter: drop-shadow(0 0 22px rgba(0,200,255,0.85));
  transform: scale(1.08);
}

.key-name {
  font-family: 'Cinzel', serif; font-size: 13px; font-weight: 700; margin-bottom: 5px;
}
...
.key-pool   {
  font-size: 11px; color: var(--gold2); margin-top: 8px;
  padding: 6px; background: #040e18; border-radius: 8px;
}
...
.vault-thumb {
  ...
  display: flex; align-items: center; justify-content: center;
  background: linear-gradient(135deg, #040e18, #020810);
  overflow: hidden;
}
.vault-img {
...
.vault-status.locked {
  ...
  background: #1a0808; border: 1px solid #ff4444; color: #ff4444;
}
...
.step-num {
  ...
  display: flex; align-items: center; justify-content: center;
  font-family: 'Cinzel', serif; font-size: 11px; color: var(--blue);
}
...
.footer-copy {
  font-size: 9px; color: #0a2a3a; letter-spacing: 2px; word-break: break-word;
}
...
/* STATUS BOX */
.status-box {
  padding: 10px; border-radius: 8px; font-size: 10px; letter-spacing: 1px;
}
...
/* WHEEL */
.wheel-wrap {
  position: relative; width: 240px; height: 240px; margin: 0 auto 18px;
}
.wheel-pointer {
...
.dial:hover {
  border-color: var(--blue); transform: scale(1.08);
...
.win-text {
  ...
  color: var(--gold); letter-spacing: 4px; text-shadow: 0 0 20px var(--gold);
}
